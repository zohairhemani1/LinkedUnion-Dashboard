          ...
          <ul class="sidebar-menu">
              ...
              <li class="has-sub active">
                  ...
                  <ul class="sub">
                      ...
                      <li class="active"><a class="" href="editable_table.html">Editable Table</a></li>
                  </ul>
              </li>
              <li class="has-sub">
                  <a href="javascript:;" class="">
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Editable Table</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
...
<div class="widget-body">
				...
				<tr class=''>
					...
					<td style='width:27%;'><a href='#' id='update_button' class='btn btn-success' >
                    <i class='icon-trash'></i> Update</a>
					<a href='#' id='delete_button'  class='btn btn-danger'>
                    <i class='icon-edit'></i> delete</a>
					<a href='view.php' id='view_button' class='btn btn-primary'>
