...
<body>
			...
			<ul class="toolbar-group">
				...
				<span class="icon" data-icon=""></span>
					...
					<iframe  id="optomaFeed" src="http://quirktools.com/screenfly/#u=http%3A//myunionapp.com/view.php?mobilemode=<?php echo $mobile;?>&w=1024&h=600&s=1" scroll="no"
